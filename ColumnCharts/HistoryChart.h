...
@class HistoryChart;
@protocol HistoryChartDelegate <NSObject>
...
@property (nonatomic,weak)id<HistoryChartDelegate> delegate;
...
@property (nonatomic,strong) NSMutableArray *columnData;            // x轴下标
@property (nonatomic,copy)NSArray *row1Data; // y1下标准
@property (nonatomic,copy)NSArray *row2Data; // y2下标准
@property (nonatomic, strong) NSMutableArray *valueDataAry1;
@property (nonatomic, strong) NSMutableArray *valueDataAry2;
@property (nonatomic, strong) NSMutableArray *valueDataAry3;
@property (nonatomic, strong) NSMutableArray *valueDataAry4;
...
@property (nonatomic,strong)UIColor *line1ChartColor;           // 折线颜色
@property (nonatomic,strong)UIColor *line2ChartColor;           // 折线颜色
@property (nonatomic,strong)UIColor *line3ChartColor;           // 折线颜色
@property (nonatomic,strong)UIColor *line4ChartColor;           // 折线颜色
